...
func (b *Blockchain) StateAt(hash common.Hash) (vm.StateDB, error) {
	...
	// Isolate txpool reads from the application's live context. In particular,
	// StateDB construction reads the context's EventManager while block
	// execution may be emitting events concurrently.
