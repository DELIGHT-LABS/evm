...
var (
	md_QueryErrorDetail               protoreflect.MessageDescriptor
	fd_QueryErrorDetail_rpc_code      protoreflect.FieldDescriptor
	fd_QueryErrorDetail_revert_data   protoreflect.FieldDescriptor
	fd_QueryErrorDetail_rpc_data_json protoreflect.FieldDescriptor
	fd_QueryErrorDetail_cosmos_error  protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_evm_vm_v1_query_proto_init()
	md_QueryErrorDetail = File_cosmos_evm_vm_v1_query_proto.Messages().ByName("QueryErrorDetail")
	fd_QueryErrorDetail_rpc_code = md_QueryErrorDetail.Fields().ByName("rpc_code")
	fd_QueryErrorDetail_revert_data = md_QueryErrorDetail.Fields().ByName("revert_data")
	fd_QueryErrorDetail_rpc_data_json = md_QueryErrorDetail.Fields().ByName("rpc_data_json")
	fd_QueryErrorDetail_cosmos_error = md_QueryErrorDetail.Fields().ByName("cosmos_error")
}

var _ protoreflect.Message = (*fastReflection_QueryErrorDetail)(nil)

type fastReflection_QueryErrorDetail QueryErrorDetail

func (x *QueryErrorDetail) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryErrorDetail)(x)
}

func (x *QueryErrorDetail) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryErrorDetail_messageType fastReflection_QueryErrorDetail_messageType
var _ protoreflect.MessageType = fastReflection_QueryErrorDetail_messageType{}

type fastReflection_QueryErrorDetail_messageType struct{}

func (x fastReflection_QueryErrorDetail_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryErrorDetail)(nil)
}
func (x fastReflection_QueryErrorDetail_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryErrorDetail)
}
func (x fastReflection_QueryErrorDetail_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryErrorDetail
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryErrorDetail) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryErrorDetail
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryErrorDetail) Type() protoreflect.MessageType {
	return _fastReflection_QueryErrorDetail_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryErrorDetail) New() protoreflect.Message {
	return new(fastReflection_QueryErrorDetail)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryErrorDetail) Interface() protoreflect.ProtoMessage {
	return (*QueryErrorDetail)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryErrorDetail) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.RpcCode != int64(0) {
		value := protoreflect.ValueOfInt64(x.RpcCode)
		if !f(fd_QueryErrorDetail_rpc_code, value) {
			return
		}
	}
	if len(x.RevertData) != 0 {
		value := protoreflect.ValueOfBytes(x.RevertData)
		if !f(fd_QueryErrorDetail_revert_data, value) {
			return
		}
	}
	if len(x.RpcDataJson) != 0 {
		value := protoreflect.ValueOfBytes(x.RpcDataJson)
		if !f(fd_QueryErrorDetail_rpc_data_json, value) {
			return
		}
	}
	if x.CosmosError != nil {
		value := protoreflect.ValueOfMessage(x.CosmosError.ProtoReflect())
		if !f(fd_QueryErrorDetail_cosmos_error, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryErrorDetail) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.evm.vm.v1.QueryErrorDetail.rpc_code":
		return x.RpcCode != int64(0)
	case "cosmos.evm.vm.v1.QueryErrorDetail.revert_data":
		return len(x.RevertData) != 0
	case "cosmos.evm.vm.v1.QueryErrorDetail.rpc_data_json":
		return len(x.RpcDataJson) != 0
	case "cosmos.evm.vm.v1.QueryErrorDetail.cosmos_error":
		return x.CosmosError != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.evm.vm.v1.QueryErrorDetail"))
		}
		panic(fmt.Errorf("message cosmos.evm.vm.v1.QueryErrorDetail does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryErrorDetail) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.evm.vm.v1.QueryErrorDetail.rpc_code":
		x.RpcCode = int64(0)
	case "cosmos.evm.vm.v1.QueryErrorDetail.revert_data":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryErrorDetail) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.evm.vm.v1.QueryErrorDetail.rpc_code":
		value := x.RpcCode
		return protoreflect.ValueOfInt64(value)
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.evm.vm.v1.QueryErrorDetail does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryErrorDetail) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.evm.vm.v1.QueryErrorDetail.rpc_code":
		x.RpcCode = value.Int()
	case "cosmos.evm.vm.v1.QueryErrorDetail.revert_data":
		x.RevertData = value.Bytes()
	case "cosmos.evm.vm.v1.QueryErrorDetail.rpc_data_json":
		x.RpcDataJson = value.Bytes()
	case "cosmos.evm.vm.v1.QueryErrorDetail.cosmos_error":
		x.CosmosError = value.Message().Interface().(*QueryErrorDetail_CosmosError)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.evm.vm.v1.QueryErrorDetail"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryErrorDetail) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.evm.vm.v1.QueryErrorDetail.cosmos_error":
		if x.CosmosError == nil {
			x.CosmosError = new(QueryErrorDetail_CosmosError)
		}
		return protoreflect.ValueOfMessage(x.CosmosError.ProtoReflect())
	case "cosmos.evm.vm.v1.QueryErrorDetail.rpc_code":
		panic(fmt.Errorf("field rpc_code of message cosmos.evm.vm.v1.QueryErrorDetail is not mutable"))
	case "cosmos.evm.vm.v1.QueryErrorDetail.revert_data":
		panic(fmt.Errorf("field revert_data of message cosmos.evm.vm.v1.QueryErrorDetail is not mutable"))
	case "cosmos.evm.vm.v1.QueryErrorDetail.rpc_data_json":
		panic(fmt.Errorf("field rpc_data_json of message cosmos.evm.vm.v1.QueryErrorDetail is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.evm.vm.v1.QueryErrorDetail"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryErrorDetail) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.evm.vm.v1.QueryErrorDetail.rpc_code":
		return protoreflect.ValueOfInt64(int64(0))
	case "cosmos.evm.vm.v1.QueryErrorDetail.revert_data":
	...
	case "cosmos.evm.vm.v1.QueryErrorDetail.rpc_data_json":
		return protoreflect.ValueOfBytes(nil)
	case "cosmos.evm.vm.v1.QueryErrorDetail.cosmos_error":
		m := new(QueryErrorDetail_CosmosError)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.evm.vm.v1.QueryErrorDetail"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryErrorDetail) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.evm.vm.v1.QueryErrorDetail", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryErrorDetail) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryErrorDetail) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryErrorDetail) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryErrorDetail) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryErrorDetail)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		_ = l
		if x.RpcCode != 0 {
			n += 1 + runtime.Sov(uint64(x.RpcCode))
		}
		l = len(x.RevertData)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.CosmosError != nil {
			encoded, err := options.Marshal(x.CosmosError)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
		...
		if len(x.RpcDataJson) > 0 {
			i -= len(x.RpcDataJson)
			copy(dAtA[i:], x.RpcDataJson)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.RpcDataJson)))
			i--
			dAtA[i] = 0x1a
		}
		if len(x.RevertData) > 0 {
			i -= len(x.RevertData)
			copy(dAtA[i:], x.RevertData)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.RevertData)))
			i--
			dAtA[i] = 0x12
		}
		if x.RpcCode != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.RpcCode))
			i--
			dAtA[i] = 0x8
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryErrorDetail: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryErrorDetail: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field RpcCode", wireType)
				}
				x.RpcCode = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field RevertData", wireType)
				}
				var byteLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.RevertData = append(x.RevertData[:0], dAtA[iNdEx:postIndex]...)
				if x.RevertData == nil {
					x.RevertData = []byte{}
				}
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field RpcDataJson", wireType)
				}
				var byteLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.RpcDataJson = append(x.RpcDataJson[:0], dAtA[iNdEx:postIndex]...)
				if x.RpcDataJson == nil {
					x.RpcDataJson = []byte{}
				}
				iNdEx = postIndex
			case 4:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field CosmosError", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.CosmosError == nil {
					x.CosmosError = &QueryErrorDetail_CosmosError{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.CosmosError); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
var (
	md_QueryErrorDetail_CosmosError           protoreflect.MessageDescriptor
	fd_QueryErrorDetail_CosmosError_codespace protoreflect.FieldDescriptor
	fd_QueryErrorDetail_CosmosError_code      protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_evm_vm_v1_query_proto_init()
	md_QueryErrorDetail_CosmosError = File_cosmos_evm_vm_v1_query_proto.Messages().ByName("QueryErrorDetail").Messages().ByName("CosmosError")
	fd_QueryErrorDetail_CosmosError_codespace = md_QueryErrorDetail_CosmosError.Fields().ByName("codespace")
	fd_QueryErrorDetail_CosmosError_code = md_QueryErrorDetail_CosmosError.Fields().ByName("code")
}

var _ protoreflect.Message = (*fastReflection_QueryErrorDetail_CosmosError)(nil)

type fastReflection_QueryErrorDetail_CosmosError QueryErrorDetail_CosmosError

func (x *QueryErrorDetail_CosmosError) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryErrorDetail_CosmosError)(x)
}

func (x *QueryErrorDetail_CosmosError) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryErrorDetail_CosmosError_messageType fastReflection_QueryErrorDetail_CosmosError_messageType
var _ protoreflect.MessageType = fastReflection_QueryErrorDetail_CosmosError_messageType{}

type fastReflection_QueryErrorDetail_CosmosError_messageType struct{}

func (x fastReflection_QueryErrorDetail_CosmosError_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryErrorDetail_CosmosError)(nil)
}
func (x fastReflection_QueryErrorDetail_CosmosError_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryErrorDetail_CosmosError)
}
func (x fastReflection_QueryErrorDetail_CosmosError_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryErrorDetail_CosmosError
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryErrorDetail_CosmosError) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryErrorDetail_CosmosError
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryErrorDetail_CosmosError) Type() protoreflect.MessageType {
	return _fastReflection_QueryErrorDetail_CosmosError_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryErrorDetail_CosmosError) New() protoreflect.Message {
	return new(fastReflection_QueryErrorDetail_CosmosError)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryErrorDetail_CosmosError) Interface() protoreflect.ProtoMessage {
	return (*QueryErrorDetail_CosmosError)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryErrorDetail_CosmosError) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Codespace != "" {
		value := protoreflect.ValueOfString(x.Codespace)
		if !f(fd_QueryErrorDetail_CosmosError_codespace, value) {
			return
		}
	}
	if x.Code != uint32(0) {
		value := protoreflect.ValueOfUint32(x.Code)
		if !f(fd_QueryErrorDetail_CosmosError_code, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryErrorDetail_CosmosError) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.evm.vm.v1.QueryErrorDetail.CosmosError.codespace":
		return x.Codespace != ""
	case "cosmos.evm.vm.v1.QueryErrorDetail.CosmosError.code":
		return x.Code != uint32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.evm.vm.v1.QueryErrorDetail.CosmosError"))
		}
		panic(fmt.Errorf("message cosmos.evm.vm.v1.QueryErrorDetail.CosmosError does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryErrorDetail_CosmosError) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.evm.vm.v1.QueryErrorDetail.CosmosError.codespace":
		x.Codespace = ""
	case "cosmos.evm.vm.v1.QueryErrorDetail.CosmosError.code":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryErrorDetail_CosmosError) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.evm.vm.v1.QueryErrorDetail.CosmosError.codespace":
		value := x.Codespace
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.evm.vm.v1.QueryErrorDetail.CosmosError does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryErrorDetail_CosmosError) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.evm.vm.v1.QueryErrorDetail.CosmosError.codespace":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryErrorDetail_CosmosError) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.evm.vm.v1.QueryErrorDetail.CosmosError.codespace":
		panic(fmt.Errorf("field codespace of message cosmos.evm.vm.v1.QueryErrorDetail.CosmosError is not mutable"))
	case "cosmos.evm.vm.v1.QueryErrorDetail.CosmosError.code":
		panic(fmt.Errorf("field code of message cosmos.evm.vm.v1.QueryErrorDetail.CosmosError is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.evm.vm.v1.QueryErrorDetail.CosmosError"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryErrorDetail_CosmosError) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.evm.vm.v1.QueryErrorDetail.CosmosError.codespace":
		return protoreflect.ValueOfString("")
	case "cosmos.evm.vm.v1.QueryErrorDetail.CosmosError.code":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryErrorDetail_CosmosError) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.evm.vm.v1.QueryErrorDetail.CosmosError", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryErrorDetail_CosmosError) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryErrorDetail_CosmosError) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryErrorDetail_CosmosError) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryErrorDetail_CosmosError) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryErrorDetail_CosmosError)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryErrorDetail_CosmosError: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryErrorDetail_CosmosError: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
// QueryErrorDetail carries transaction rejection data in a gRPC error status.
// It is an error detail, not a successful query response.
type QueryErrorDetail struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// rpc_code is the Ethereum JSON-RPC error code, not the gRPC status code.
	RpcCode int64 `protobuf:"varint,1,opt,name=rpc_code,json=rpcCode,proto3" json:"rpc_code,omitempty"`
	// revert_data contains Solidity ABI-encoded error bytes.
	RevertData []byte `protobuf:"bytes,2,opt,name=revert_data,json=revertData,proto3" json:"revert_data,omitempty"`
	// rpc_data_json preserves the JSON-RPC error data as JSON, including null.
	RpcDataJson []byte `protobuf:"bytes,3,opt,name=rpc_data_json,json=rpcDataJson,proto3" json:"rpc_data_json,omitempty"`
	// cosmos_error is present only when the source has a Cosmos error identity.
	CosmosError *QueryErrorDetail_CosmosError `protobuf:"bytes,4,opt,name=cosmos_error,json=cosmosError,proto3" json:"cosmos_error,omitempty"`
}

func (x *QueryErrorDetail) Reset() {
	*x = QueryErrorDetail{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_evm_vm_v1_query_proto_msgTypes[30]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *QueryErrorDetail) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryErrorDetail) ProtoMessage() {}

// Deprecated: Use QueryErrorDetail.ProtoReflect.Descriptor instead.
func (*QueryErrorDetail) Descriptor() ([]byte, []int) {
	return file_cosmos_evm_vm_v1_query_proto_rawDescGZIP(), []int{30}
}

func (x *QueryErrorDetail) GetRpcCode() int64 {
	if x != nil {
		return x.RpcCode
	}
	return 0
...
func (x *QueryErrorDetail) GetRevertData() []byte {
	if x != nil {
		return x.RevertData
	}
	return nil
...
func (x *QueryErrorDetail) GetRpcDataJson() []byte {
	if x != nil {
		return x.RpcDataJson
	}
	return nil
}

func (x *QueryErrorDetail) GetCosmosError() *QueryErrorDetail_CosmosError {
	if x != nil {
		return x.CosmosError
	}
	return nil
}

// CosmosError identifies a registered Cosmos error independently of its text.
type QueryErrorDetail_CosmosError struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// codespace is the namespace of the registered Cosmos error.
	Codespace string `protobuf:"bytes,1,opt,name=codespace,proto3" json:"codespace,omitempty"`
	// code is the error code within the codespace.
	Code uint32 `protobuf:"varint,2,opt,name=code,proto3" json:"code,omitempty"`
}

func (x *QueryErrorDetail_CosmosError) Reset() {
	*x = QueryErrorDetail_CosmosError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_evm_vm_v1_query_proto_msgTypes[31]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryErrorDetail_CosmosError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryErrorDetail_CosmosError) ProtoMessage() {}

// Deprecated: Use QueryErrorDetail_CosmosError.ProtoReflect.Descriptor instead.
func (*QueryErrorDetail_CosmosError) Descriptor() ([]byte, []int) {
	return file_cosmos_evm_vm_v1_query_proto_rawDescGZIP(), []int{30, 0}
}

func (x *QueryErrorDetail_CosmosError) GetCodespace() string {
	if x != nil {
		return x.Codespace
	}
	return ""
...
func (x *QueryErrorDetail_CosmosError) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_cosmos_evm_vm_v1_query_proto_rawDesc = []byte{
	...
	,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x25, 0x12, 0x23, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x65,
	0x76, 0x6d, 0x2f, 0x76, 0x6d, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x2f, 0x7b, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x7d, 0x12, 0x9e, 0x01, 0x0a, 0x0d, 0x43,
	0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x2b, 0x2e, 0x63,
	...
	0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2c, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	...
	0x2a, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x65, 0x76, 0x6d, 0x2f, 0x76, 0x6d, 0x2f,
	0x76, 0x31, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x2f, 0x7b, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x7d, 0x12, 0xaf, 0x01, 0x0a, 0x10,
	0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x12, 0x2e, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d, 0x2e, 0x76, 0x6d,
	...
	0x1a, 0x2f, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d, 0x2e, 0x76, 0x6d,
	0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
	...
	0x6f, 0x73, 0x2f, 0x65, 0x76, 0x6d, 0x2f, 0x76, 0x6d, 0x2f, 0x76, 0x31, 0x2f, 0x76, 0x61, 0x6c,
	...
	0x0a, 0x07, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x25, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d, 0x2e, 0x76, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65,
	...
	0x12, 0x24, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x65, 0x76, 0x6d, 0x2f, 0x76, 0x6d,
	0x2f, 0x76, 0x31, 0x2f, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x2f, 0x7b, 0x61, 0x64,
	0x64, 0x72, 0x65, 0x73, 0x73, 0x7d, 0x12, 0x8b, 0x01, 0x0a, 0x07, 0x53, 0x74, 0x6f, 0x72, 0x61,
	0x67, 0x65, 0x12, 0x25, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d, 0x2e,
	0x76, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x61,
	0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d, 0x2e, 0x76, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65,
	...
	0x6f, 0x73, 0x2f, 0x65, 0x76, 0x6d, 0x2f, 0x76, 0x6d, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x74, 0x6f,
	0x72, 0x61, 0x67, 0x65, 0x2f, 0x7b, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x7d, 0x2f, 0x7b,
	0x6b, 0x65, 0x79, 0x7d, 0x12, 0x7a, 0x0a, 0x04, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x22, 0x2e, 0x63,
	0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d, 0x2e, 0x76, 0x6d, 0x2e, 0x76, 0x31, 0x2e,
	0x51, 0x75, 0x65, 0x72, 0x79, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x23, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d, 0x2e, 0x76, 0x6d,
	...
	0x12, 0x77, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x24, 0x2e, 0x63, 0x6f, 0x73,
	0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d, 0x2e, 0x76, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75,
	...
	0x18, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x65, 0x76, 0x6d, 0x2f, 0x76, 0x6d, 0x2f,
	0x76, 0x31, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x78, 0x0a, 0x07, 0x45, 0x74, 0x68,
	0x43, 0x61, 0x6c, 0x6c, 0x12, 0x20, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x76,
	0x6d, 0x2e, 0x76, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x74, 0x68, 0x43, 0x61, 0x6c, 0x6c, 0x52,
	...
	0x2f, 0x65, 0x76, 0x6d, 0x2f, 0x76, 0x6d, 0x2f, 0x76, 0x31, 0x2f, 0x65, 0x74, 0x68, 0x5f, 0x63,
	0x61, 0x6c, 0x6c, 0x12, 0x7e, 0x0a, 0x0b, 0x45, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x65, 0x47,
	0x61, 0x73, 0x12, 0x20, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d, 0x2e,
	...
	0x6d, 0x2e, 0x76, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x65,
	0x47, 0x61, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x26, 0x82, 0xd3, 0xe4,
	0x93, 0x02, 0x20, 0x12, 0x1e, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x65, 0x76, 0x6d,
	0x2f, 0x76, 0x6d, 0x2f, 0x76, 0x31, 0x2f, 0x65, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x65, 0x5f,
	0x67, 0x61, 0x73, 0x12, 0x7c, 0x0a, 0x07, 0x54, 0x72, 0x61, 0x63, 0x65, 0x54, 0x78, 0x12, 0x25,
	0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d, 0x2e, 0x76, 0x6d, 0x2e, 0x76,
	...
	,
	...
	,
	...
	0x73, 0x65, 0x46, 0x65, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x22, 0x82,
	0xd3, 0xe4, 0x93, 0x02, 0x1c, 0x12, 0x1a, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x65,
	0x76, 0x6d, 0x2f, 0x76, 0x6d, 0x2f, 0x76, 0x31, 0x2f, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x66, 0x65,
	0x65, 0x12, 0x77, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x24, 0x2e, 0x63, 0x6f,
	...
	,
...
var file_cosmos_evm_vm_v1_query_proto_goTypes = []interface{}{
	...
	(*QueryErrorDetail)(nil),               // 30: cosmos.evm.vm.v1.QueryErrorDetail
	(*QueryErrorDetail_CosmosError)(nil),   // 31: cosmos.evm.vm.v1.QueryErrorDetail.CosmosError
...
var file_cosmos_evm_vm_v1_query_proto_depIdxs = []int32{
	...
	38, // 12: cosmos.evm.vm.v1.QueryTraceCallRequest.trace_config:type_name -> cosmos.evm.vm.v1.TraceConfig
	39, // 13: cosmos.evm.vm.v1.QueryTraceCallRequest.block_time:type_name -> google.protobuf.Timestamp
	31, // 14: cosmos.evm.vm.v1.QueryErrorDetail.cosmos_error:type_name -> cosmos.evm.vm.v1.QueryErrorDetail.CosmosError
	...
	20, // 24: cosmos.evm.vm.v1.Query.TraceTx:input_type -> cosmos.evm.vm.v1.QueryTraceTxRequest
	22, // 25: cosmos.evm.vm.v1.Query.TraceBlock:input_type -> cosmos.evm.vm.v1.QueryTraceBlockRequest
	24, // 26: cosmos.evm.vm.v1.Query.TraceCall:input_type -> cosmos.evm.vm.v1.QueryTraceCallRequest
	26, // 27: cosmos.evm.vm.v1.Query.BaseFee:input_type -> cosmos.evm.vm.v1.QueryBaseFeeRequest
	0,  // 28: cosmos.evm.vm.v1.Query.Config:input_type -> cosmos.evm.vm.v1.QueryConfigRequest
	28, // 29: cosmos.evm.vm.v1.Query.GlobalMinGasPrice:input_type -> cosmos.evm.vm.v1.QueryGlobalMinGasPriceRequest
	...
	19, // 38: cosmos.evm.vm.v1.Query.EstimateGas:output_type -> cosmos.evm.vm.v1.EstimateGasResponse
	21, // 39: cosmos.evm.vm.v1.Query.TraceTx:output_type -> cosmos.evm.vm.v1.QueryTraceTxResponse
	23, // 40: cosmos.evm.vm.v1.Query.TraceBlock:output_type -> cosmos.evm.vm.v1.QueryTraceBlockResponse
	25, // 41: cosmos.evm.vm.v1.Query.TraceCall:output_type -> cosmos.evm.vm.v1.QueryTraceCallResponse
	27, // 42: cosmos.evm.vm.v1.Query.BaseFee:output_type -> cosmos.evm.vm.v1.QueryBaseFeeResponse
	1,  // 43: cosmos.evm.vm.v1.Query.Config:output_type -> cosmos.evm.vm.v1.QueryConfigResponse
	29, // 44: cosmos.evm.vm.v1.Query.GlobalMinGasPrice:output_type -> cosmos.evm.vm.v1.QueryGlobalMinGasPriceResponse
...
func file_cosmos_evm_vm_v1_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_evm_vm_v1_query_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryErrorDetail_CosmosError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
